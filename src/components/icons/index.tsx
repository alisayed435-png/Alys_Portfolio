...
export const UpworkIcon: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
    ...
    {...props}
  >
    <path d="M10 7C5.03 7 1 11.03 1 16s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 16c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z" />
    <path d="M10 9c-3.314 0-6 2.686-6 6s2.686 6 6 6 6-2.686 6-6-2.686-6-6-6zm2 7h-4v-2h4v2z" />
  </svg>
);
